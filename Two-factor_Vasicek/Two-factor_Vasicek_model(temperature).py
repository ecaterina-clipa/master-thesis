...
temperature = pd.read_excel(r'C:\Users\Cathy\Documents\DOC\QF-UniBo\TESI\3_Data\temperature.xlsx') #change path
#Year fractions
original_tau = temperature['Tau']
#Zero rates from all the scenarios
original = temperature['Original']
zrSSP119 = temperature['SSP119']
zrSSP126 = temperature['SSP126']
zrSSP245 = temperature['SSP245']
zrSSP370 = temperature['SSP370']
zrSSP585 = temperature['SSP585']
...
writer = pd.ExcelWriter('temperature_results.xlsx', engine='xlsxwriter')
...
SSP = pd.read_excel(r'C:\Users\Cathy\Documents\DOC\QF-UniBo\TESI\3_Data\temperature_results.xlsx')
...
ax.plot(original_tau, SSP['Zr_SSP119'], '.', color = 'r', label = 'Model')
...
ax.plot(original_tau, SSP['Zr_SSP126'], '.', color = 'red', label = 'Model')
ax.grid(axis = 'y', linewidth = 0.5)
ax.legend()
...
ax.plot(original_tau, SSP['Zr_SSP245'], '.', color = 'red', label = 'Model')
ax.grid(axis = 'y', linewidth = 0.5)
ax.legend()
...
ax.plot(original_tau, SSP['Zr_SSP370'], '.', color = 'red', label = 'Model')
ax.grid(axis = 'y', linewidth = 0.5)
ax.legend()
...
ax.plot(original_tau, SSP['Zr_SSP585'], '.', color = 'red', label = 'Model')
ax.grid(axis = 'y', linewidth = 0.5)
ax.legend()
