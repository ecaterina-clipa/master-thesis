...
# # Zero Curve Benchmark for emissions
...
#df6m_complete.to_excel('em_benchmark.xlsm')
...
df_Pmodified = pd.read_excel(r'C:\Users\Cathy\Documents\DOC\QF-UniBo\TESI\3_Data\em_benchmark.xlsm', sheet_name='Scenarios') #change the path
...
ax.legend()
ax.set_title('Emissions Benchmark Curves')
...
emissions['Tau'] = [Actual365Fixed().yearFraction(today, d) for d in dates]
emissions['Original'] = zero_rate
emissions['SSP119'] = zrSSP119
emissions['SSP126'] = zrSSP126
emissions['SSP245'] = zrSSP245
emissions['SSP370'] = zrSSP370
emissions['SSP585'] = zrSSP585
emissions
...
#emissions.to_excel('emissions.xlsx')
